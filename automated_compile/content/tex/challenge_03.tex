...
Let $r\in \mathbb{N}$.
Provide decimal numbers $d_1$ and $d_2$ with $|d_2-d_1|\leq (4-\sqrt{2}) \cdot 0.98^r$ so that for all sufficiently large $t\in \mathbb{N}$
\[
...
The problem was solved for $1 \leq r \leq 3$ by Campos, Griffiths, Morris and Sahasrabudhe
\cite{campos2026exponential} combined with the better bound $R(t)\leq 3.8^t$ from the follow-up paper by
Gupta, Ndiaye, Norin and Wei \cite{gupta2024optimizing}. It is open from $r=4$ onwards.
