...
As $r\to\infty$, the bound approaches $\frac{1}{2}$, recovering the full conjecture in the limit. The best published lower bound on the density ($\approx 0.382$, obtained via the entropy method~\cite{sawin2022unionclosed, chase2022approximate}) settles the cases $r\leq 6$; the conjecture is open for all $r\geq 7$.
