...
export const problems: Problem[] = [
  ...
  },
  {
    ...
    shortDesc: "Characterize the excluded minors for representability over the finite field GF(pʳ). A fundamental problem in matroid theory.",
    largestParameterKnown: "r = 1",
    description: `A matroid is GF(pʳ)-representable if it can be represented by a matrix over the finite field with pʳ elements. The excluded minors are the minimal obstructions to such representability.\n\nFor pʳ=2 (binary matroids), the only excluded minor is U_{2,4} (Tutte, 1958). For pʳ=3 (ternary matroids), the excluded minors are U_{2,5}, U_{3,5}, F_7, and F_7^* (Rado's theorem). Beyond this, the problem remains wide open.`,
    status: "Not yet formalized in Mathlib4.",
  ...
  },
  {
    ...
    shortDesc: "The smallest n such that every graph on n vertices contains either a clique of size t or an independent set of size t.",
    largestParameterKnown: "r = 1",
    description: `The Ramsey number R(t) is the smallest integer n such that every simple graph on n vertices contains either a clique of size t or an independent set of size t. Even R(5) remains unknown.\n\nFor the parametrized version, one seeks tighter and tighter bounds for families of Ramsey numbers.`,
  ...
  },
  {
    ...
    shortDesc: "For every graph H, there exists a constant c > 0 such that every H-free graph has a clique or stable set of size n^c.",
    largestParameterKnown: "r = 1",
    description: `The Erdős–Hajnal conjecture asserts that for every fixed graph H, there exists a constant c = c(H) > 0 such that every graph on n vertices that does not contain H as an induced subgraph has either a clique or a stable set of size at least n^c.\n\nThis is known for only a handful of graphs H.`,
    status: "Not yet formalized in Mathlib4.",
    info: "Induced subgraphs and the Erdős–Hajnal property are not yet in Mathlib4. Basic graph theory definitions exist as building blocks.",
  ...
  },
  {
    ...
    largestParameterKnown: "r = 1",
    description: `Ryser's conjecture states that in every r-partite r-uniform hypergraph, the vertex cover number tau is at most (r-1) times the matching number nu. For r=2 this is König's theorem. For r=3 it was proved by Aharoni (2001). The general case remains open.\n\nDisproving the conjecture for some r would also be a major result.`,
    status: "Not yet formalized in Mathlib4.",
